...
#关于交叉验证介绍：https://www.cnblogs.com/ysugyl/p/8707887.html
...
print(metrics.confusion_matrix(test_target, test_est,labels=[0,1]))  # 混淆矩阵https://www.cnblogs.com/cnkai/p/7755134.html
print(metrics.classification_report(test_target, test_est))  # 计算评估指标：https://www.cnblogs.com/cnkai/p/7755141.html
...
#test_est_p[test_target == 1]#将目标变量为1（即流失的）样本其预测结果（概率值）绘制柱形图
# In[21]:
...
plt.title('ROC curve')#关于ROC曲线：https://www.cnblogs.com/dlml/p/4403482.html
plt.show()
#这里表现出了过渡拟合的情况
#########################################################################################
#参数调优
